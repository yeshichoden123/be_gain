...
import com.android.be_gain.Constants;
import com.android.be_gain.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get noteId from intent that we passed in intent1
                ...
                .addOnSuccessListener(new OnSuccessListener<byte[]>()
                {
                    ...
                    public void onSuccess(byte[] bytes)
                    {
                        ...
                        binding.pdfView.fromBytes(bytes)
                                .swipeHorizontal(false)    // set false to scroll vertical, set true to horizontal
